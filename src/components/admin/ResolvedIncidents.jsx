...
// import { getIncidentsByStatus, subscribe } from '../../data/incidents';
// import IncidentCard from '../../IncidentCard';

// const ResolvedIncidents = () => {
//   const [incidents, setIncidents] = useState(getIncidentsByStatus('resolved'));

//   useEffect(() => {
//     const unsubscribe = subscribe(() => {
//       setIncidents(getIncidentsByStatus('resolved'));
//     });
//     return () => unsubscribe();
//   }, []);
...
//       <div className="mb-6">
//         <h2 className="text-2xl font-bold text-foreground mb-2">Resolved Incidents</h2>
//         <p className="text-muted-foreground">Incidents that have been successfully resolved</p>
//       </div>

//       {incidents.length === 0 ? (
//         <div className="text-center py-16 bg-card rounded-xl border border-border">
//           <p className="text-muted-foreground text-lg">No resolved incidents</p>
//         </div>
//       ) : (
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="container mx-auto px-6 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Resolved Incidents</h2>
          <p className="text-gray-600 text-base">Incidents that have been successfully resolved</p>
        </div>

        {incidents.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl border border-gray-200">
            <p className="text-gray-500 text-lg">No resolved incidents</p>
          </div>
        ) : (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {incidents.map(incident => (
              <div key={incident.id} className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-lg transition-shadow duration-200 opacity-75">
                {/* Icon and Badge */}
